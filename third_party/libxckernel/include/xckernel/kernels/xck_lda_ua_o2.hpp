...
namespace xckernel {
namespace detail_xck_lda_ua_o2 {
...
int xck_lda_ua_o2_t(int64_t npts, int64_t nbf,
    ...
    if (!c) return 1;
    stage_a<T, Txc>(npts, 2, detail_xck_lda_ua_o2::c0, detail_xck_lda_ua_o2::o0, detail_xck_lda_ua_o2::f0, detail_xck_lda_ua_o2::NFLD, fields, xc, c);
