...
int xck_lda_r_o1_t(int64_t npts, int64_t nbf,
    ...
    if (!c) return 1;
    stage_a<T, Txc>(npts, 1, detail_xck_lda_r_o1::c0, detail_xck_lda_r_o1::o0, detail_xck_lda_r_o1::f0, detail_xck_lda_r_o1::NFLD, fields, xc, c);
