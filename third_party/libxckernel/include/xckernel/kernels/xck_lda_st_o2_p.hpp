...
namespace xckernel {
namespace detail_xck_lda_st_o2_p {
...
int xck_lda_st_o2_p_t(int64_t npts, int64_t nbf,
    ...
    if (!c) return 1;
    stage_a<T, Txc>(npts, 2, detail_xck_lda_st_o2_p::c0, detail_xck_lda_st_o2_p::o0, detail_xck_lda_st_o2_p::f0, detail_xck_lda_st_o2_p::NFLD, fields, xc, c);
