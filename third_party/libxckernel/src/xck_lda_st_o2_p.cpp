...
const char* xck_lda_st_o2_p_scal_names[4] = {
    "w",
    "rho_a_p1",
    "v2rho2_0",
    "v2rho2_1",
...
int xck_lda_st_o2_p(int64_t npts, int64_t nbf,
    ...
    return xckernel::xck_lda_st_o2_p_t<double, double>(
