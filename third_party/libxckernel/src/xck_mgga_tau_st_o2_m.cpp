...
#include "xckernel/kernels/xck_mgga_tau_st_o2_m.hpp"

extern "C" {

const char* xck_mgga_tau_st_o2_m_scal_names[32] = {
    "w",
    "grad_rho_a_x",
    "grad_rho_a_y",
    "grad_rho_a_z",
...
int xck_mgga_tau_st_o2_m(int64_t npts, int64_t nbf,
    ...
    return xckernel::xck_mgga_tau_st_o2_m_t<double, double>(
