...
const char* xck_gga_st_o2_p_scal_names[22] = {
    "w",
    "grad_rho_a_x",
    "grad_rho_a_y",
    "grad_rho_a_z",
...
int xck_gga_st_o2_p(int64_t npts, int64_t nbf,
    ...
    return xckernel::xck_gga_st_o2_p_t<double, double>(
