...
| =D3Pot= | =D3= | Enable with =-Dwith_dftd3=true=; use pixi env =dftd3=. BJ/zero damping, functional key, explicit ATM flag |
| =D4Pot= | =D4= | Enable with =-Dwith_dftd4=true=; use pixi env =dftd4=. Functional key, charge, explicit ATM/many-body flag |
